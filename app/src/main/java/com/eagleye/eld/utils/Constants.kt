...
object Constants {
    ...
    // API base URL. There is no dev environment — all builds hit production.
    const val BASE_URL = "https://api.eagleyetek.com/"
    const val SOCKET_URL = "https://api.eagleyetek.com/"
