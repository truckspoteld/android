package com.truckspot.eld.fragment.ui.home
...
import com.truckspot.eld.R.drawable.home_bg_deign
import com.truckspot.eld.R.drawable.home_bg_design_selected
import com.truckspot.eld.R.layout.*
import com.truckspot.eld.R.string.shipping_number
import com.truckspot.eld.R.string.trailer_number
import com.truckspot.eld.databinding.FragmentHomeBinding
import com.truckspot.eld.fragment.Dashboard
import com.truckspot.eld.fragment.ui.viewmodels.DashboardViewModel
import com.truckspot.eld.LoginActivity
import com.truckspot.eld.models.DRIVE_MODE.*
import com.truckspot.eld.models.UserLog
import com.truckspot.eld.pt.devicemanager.AppModel
import com.truckspot.eld.pt.devicemanager.TrackerManagerActivity
import com.truckspot.eld.pt.devicemanager.TrackerService
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import com.truckspot.eld.request.AddLogRequest
import com.truckspot.eld.request.updateLogRequest
import com.truckspot.eld.utils.*
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_DRIVING
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_OFF
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_ON
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_PERSONAL
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_SLEEPING
import com.truckspot.eld.utils.Utils.dialogInterface
...
import com.truckspot.eld.models.CodriverItem
import com.truckspot.eld.request.AddOffsetRequest
import com.truckspot.eld.request.DriverShipmentRequest
import com.truckspot.eld.utils.PrefConstants.TRUCK_MODE_YARD
import com.truckspot.eld.utils.Utils.getDouble
import com.truckspot.eld.utils.Utils.toHoursMinutesFormate
...
class HomeFragment : Fragment(), OnClickListener {
    ...
    override fun onCreateView(
        ...
        binding.cvCarrier.setOnClickListener {
            playClickAnimation(it)
            if (isNeedToconnect) {
        ...
        binding.cvSpeed.setOnClickListener { playClickAnimation(it) }
    ...
    private fun updateUIAfterModeChange(mode: String) {
        when (mode) {
            ...
            TRUCK_MODE_YARD -> {
                updateUI(binding.btnYard)
            }
            TRUCK_MODE_PERSONAL -> {
                updateUI(binding.btnPersonal)
            }
        }
    }
    ...
    private fun updateUIBasedOnLogs(data: HomeDataModel?) {
        ...
        if (filterForSelection != null && filterForSelection.isNotEmpty()) {
            ...
            when (latestMode) {
                ...
                TRUCK_MODE_YARD -> updateUI(binding.btnYard)
                TRUCK_MODE_PERSONAL -> updateUI(binding.btnPersonal)
            }
        } else {
            // Only set OFF if user is not already on an active mode
            val currentMode = homeViewModel.trackingMode.get()
    ...
    private fun updateTelemetryInfo() {
        try {
            ...
            if (lastEvent != null) {
                ...
                // Update top-left pill to ON (Green)
                binding.tvBluetoothStatusText.text = "ON"
                ...
                // Update top-left pill to OFF (Red)
                binding.tvBluetoothStatusText.text = "OFF"
